...
map("n", "<C-S-J>", "3<C-w>-", { desc = "Resize Down", noremap = true, silent = false })
map("n", "<C-S-K>", "3<C-w>+", { desc = "Resize Up", noremap = true, silent = false })
map("n", "<C-S-L>", "3<C-w><", { desc = "Resize Right", noremap = true, silent = false })
...
map("n", "<leader>bx", ":bdelete<cr>", { desc = "Delete Buffer", noremap = true, silent = true })
...
map("n", "<leader>ec", ":e ~/.config/nvim/lua/anvim/<cr>", { desc = "Config Dir", noremap = true, silent = true })
